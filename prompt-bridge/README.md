...
- **Production**: `https://dsutclif.github.io/PromptEasy/index.html?id=[kebab-case-id]`
- **Development**: `https://dsutclif.github.io/PromptEasy/index-dev.html?id=[kebab-case-id]`

### Step 3: Update Link Registry
Add the new URLs to `/prompt-bridge/prompt-links.txt`:
```
## Production Links (Published Extension)
https://dsutclif.github.io/PromptEasy/index.html?id=[your-new-id]

## Development Links (Unpacked Extension)  
https://dsutclif.github.io/PromptEasy/index-dev.html?id=[your-new-id]
```
...
```
https://dsutclif.github.io/PromptEasy/index.html?id=email-writer
https://dsutclif.github.io/PromptEasy/index.html?id=code-reviewer
```
